...
<body>
   ...
   <!---------------------------------- 이름, 핸드폰 번호로 찾기 ----------------------------------->
    ...
    <form action="<%=contextPath %>/searchPwdClick.me" method="post" id="search-form">
    ...
    <div align="center" id="area3">
      ...
      <div align="center" id="area1">
        <table>
            ...
            <tr>
              <td>
                <div id="main-title"> <i class="glyphicon glyphicon-user"></i> &nbsp; 비밀번호 찾기 &nbsp;&nbsp;</div>
                <div id="sub-title"  style="color: rgb(110, 110, 110);">  |&nbsp;&nbsp;아이디, 핸드폰번호로 비밀번호 찾기 </div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <table width="380px" height="70px" align="center" border="0"
                ...
                <td>아이디 </td>
                <td><input type="text" name="userId" id="userId" style="width: 300px"></td>
                </tr>
                
                <tr>
                <td>이메일 </td>
                <td><input type="text" name="email" id="phone" style="width: 300px"></td>
            ...
            <tr>
              ...
              <table width="100px" height="10px" border="0"
                ...
                <tr>
                <td><input type="submit" class="btn btn-info" value="찾기" align="center" style="cursor: pointer;" onClick="pwd_search2()"></td>
                <td><input type="button" class="btn btn-secondary" value="취소" align="center" style="cursor: pointer;" onclick="history.back();"></td>
                </tr>
                  <br>
              </table>
              </td>
