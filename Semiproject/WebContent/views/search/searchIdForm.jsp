...
<body>
   ...
   <!---------------------------------- 이름, 핸드폰 번호로 찾기 ----------------------------------->
    ...
    <form action="<%=contextPath %>/searchIdClick.me" method="post" id="search-form">
        ...
        <table>
            ...
            <tr>
              ...
              <table width="380px" height="70px" align="center" border="0"
                ...
                <!-- <td><input type="text" name="phone" id="phone" style="width: 300px" placeholder=" ex) 010-0000-0000"></td> -->
            ...
            <tr>
              ...
              <table width="100px" height="10px" border="0"
                ...
                <tr>
                <td><input type="submit" class="btn btn-info" value="찾기" align="center" style="cursor: pointer;" onClick= "return id_search1()"></td>
                <td><input type="reset" class="btn btn-secondary" value="취소" align="center" style="cursor: pointer;"  onclick="history.back();"></td>
                </tr>
                  <br>
              </table>
              </td>
 ...
 <!---------------------------------- 자바 스크립트 ----------------------------------->
    ...
    <script>
          ...
          function id_search1(){
	          ...
	          if(!regExp.test(userName)){ //정규 표현식을 만족하지 않으면
